...
import com.wsun.seap.dao.persistence.dialect.db.MySQLDialect;
import com.wsun.seap.dao.persistence.dialect.db.OracleDialect;
    ...
    protected static Page<Object> convertParameter(Object parameterObject) {
        try {
            if (parameterObject instanceof Page) {
                ...
                return (Page<Object>) ReflectionsUtil.getFieldValue(parameterObject, PAGE);
            }
        } catch (Exception e) {
            return null;
        }
